            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input type="number" min="1" className="w-full border p-2 rounded-lg text-sm" value={newOrder.quantity === '' ? '' : newOrder.quantity} onChange={e => setNewOrder({...newOrder, quantity: e.target.value === '' ? '' : Number(e.target.value)})} />
                </div>
              </div>
